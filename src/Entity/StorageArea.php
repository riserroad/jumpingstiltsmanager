...
/**
 * @ORM\Entity(repositoryClass="App\Repository\StorageAreaRepository")
 */
class StorageArea
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\JumpingTilt", mappedBy="storageArea")
     */
    ...
    public function addJumpingTilt(JumpingTilt $jumpingTilt): self
    {
        if (!$this->jumpingTilts->contains($jumpingTilt)) {
            ...
            $jumpingTilt->setStorageArea($this);
        }
    ...
    public function removeJumpingTilt(JumpingTilt $jumpingTilt): self
    {
        if ($this->jumpingTilts->contains($jumpingTilt)) {
            ...
            if ($jumpingTilt->getStorageArea() === $this) {
                $jumpingTilt->setStorageArea(null);
            }
        }
