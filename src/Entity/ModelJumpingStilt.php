...
/**
 * @ORM\Entity(repositoryClass="App\Repository\ModelJumpingStiltRepository")
 */
class ModelJumpingStilt
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\JumpingTilt", mappedBy="model")
     */
    ...
    public function removeJumpingTilt(JumpingTilt $jumpingTilt): self
    {
        if ($this->jumpingTilts->contains($jumpingTilt)) {
            ...
            if ($jumpingTilt->getModel() === $this) {
                $jumpingTilt->setModel(null);
            }
        }
